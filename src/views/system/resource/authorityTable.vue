        ...
        <el-main>
          <transition name="el-fade-in">
            <el-form ref="authorityForm" :rules="rules" :model="formData" v-show="modifyVisible" label-width="100px" size="small" style="width: 400px;">
              ...
              <el-input v-model="formData.description" :autosize="{ minRows: 2, maxRows: 4}" type="textarea" placeholder="请输入..."></el-input>
              </el-form-item>
              ...
              <el-form-item>
                <el-button type="primary" @click="submitForm" size="small" v-show="hasAuthority('sysmgr.resource.authority.save')">保存</el-button>
                <el-button type="danger" v-show="nodeDeleteVisible && hasAuthority('sysmgr.resource.authority.delete')" @click="drop" size="small" >删除</el-button>
              </el-form-item>
            </el-form>
          </transition>
        </el-main>
