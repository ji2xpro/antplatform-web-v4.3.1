      ...
      <el-container>
        ...
        <el-main>
          <transition name="el-fade-in">
            <el-form v-show="modifyVisible" ref="menuForm" :rules="rules" :model="formData" label-width="100px" size="small" style="width: 400px;">
              <el-form-item label="权限编码" prop="code">
                <el-cascader v-model="auth_path" :options="options" :show-all-levels="false" :props="props_auth" style="width: 100%;" />
              </el-form-item>
              ...
              <el-form-item>
                <el-button v-show="hasAuthority('sysmgr.resource.menu.save')" type="primary" size="small" @click="submitForm">保存</el-button>
                <el-button v-show="nodeDeleteVisible && hasAuthority('sysmgr.resource.menu.delete')" type="danger" size="small" @click="drop">删除</el-button>
              </el-form-item>
            </el-form>
          </transition>
        </el-main>
